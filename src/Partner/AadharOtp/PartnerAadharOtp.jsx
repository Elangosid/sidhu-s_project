...
function OTPForm() {
  ...
  const verifyOTP = async () => {
    const client_id = localStorage.getItem('Partnerclient_id');
    if (!client_id) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        localStorage.setItem('PartnerAadhaarProfile', data.data.profile_image);
        localStorage.setItem('PartnerAadhaarAddress', addressString);
        localStorage.setItem('PartnerAadhaarMobileHash', data.data.mobile_hash);
        localStorage.setItem('PartnerAadhaarNumber', data.data.aadhaar_number);
        localStorage.setItem('ParnerAadhaarName', data.data.full_name);
