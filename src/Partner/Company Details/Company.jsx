...
const Company = () => {
  ...
  const PinCode = localStorage.getItem('Partnerstate');
  const State = localStorage.getItem('Partnerpincode');
  const AddressImage = localStorage.getItem('PartnerMapImageUrl');
  useEffect(() => {
    const Address = localStorage.getItem('Partneraddress');
    const PinCode = localStorage.getItem('Partnerstate');
    const State = localStorage.getItem('Partnerpincode');
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      // localStorage.removeItem('Partnerstate');
      // localStorage.removeItem('Partnerpincode');
      // localStorage.removeItem('PartnerMapImageUrl');
      localStorage.clear();
      Navigate('/partner-home');
      localStorage.getItem('partnerExistId');
    } catch (error) {
