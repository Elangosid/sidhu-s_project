...
const Gst = () => {
  ...
  const handleClick = async (e) => {
    ...
    localStorage.setItem('PartnerDocumentgstNo', GstDocumentNumber);
    ...
    uploadTask.on(
      ...
      () => {
        ...
        getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
          ...
          localStorage.setItem('PartnerImageUrl', downloadURL);
  ...
  localStorage.setItem('PartnerImageUrl', ImageUrl);
