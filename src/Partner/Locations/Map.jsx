...
const Map = () => {
  ...
  const handleClick = async (e) => {
    ...
    localStorage.setItem('Partneraddress', address);
    localStorage.setItem('Partnerstate', state);
    localStorage.setItem('Partnerpincode', pincode);
    ...
    try {
      ...
      localStorage.setItem('PartnerMapImageUrl', imageURL);
