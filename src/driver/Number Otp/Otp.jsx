...
function OTPForm() {
  ...
  const handleClick = async (e) => {
    ...
    if (!allFieldsFilled) {
      ...
      const mobileNumber = localStorage.getItem('DriverNumber');
      ...
      if (enteredOTP === storedOTP) {
        ...
        try {
          ...
          if (existingRetailer) {
            ...
            localStorage.setItem('DriverExistId', existingRetailer._id); // Store mobile number in local storage
            console.log(existingRetailer._id);

            if (existingRetailer.KYC) {
              Navigate('/driver-home');
            } else {
              Navigate('/driver-kyc');
            }
          } else {
            Navigate('/driver-code');
          }
        } catch (error) {
          ...
          <div className='card '>
            <div className='card-body p-5 text-center'>
              ...
              <p>
                ...
                {localStorage.getItem('DriverNumber')}
              </p>
