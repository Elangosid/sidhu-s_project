...
function OTPForm() {
  ...
  const verifyOTP = async () => {
    const client_id = localStorage.getItem('Driverclient_id');
    if (!client_id) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        localStorage.setItem('DriverAadhaarProfile', data.data.profile_image);
        localStorage.setItem('DriverAadhaarAddress', addressString);
        localStorage.setItem('DriverAadhaarMobileHash', data.data.mobile_hash);
        localStorage.setItem('DriverAadhaarNumber', data.data.aadhaar_number);
        localStorage.setItem('DriverAadhaarName', data.data.full_name);
        Navigate('/driver-kyc');
      } else {
