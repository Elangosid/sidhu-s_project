...
const Map = () => {
  ...
  const handleClick = async (e) => {
    ...
    localStorage.setItem('ManufactureAddress', address);
    localStorage.setItem('ManufactureState', state);
    localStorage.setItem('ManufacturePincode', pincode);
    ...
    try {
      ...
      localStorage.setItem('ManufactureAddresImage', imageURL);
