...
const Registration = () => {
  ...
  const handleClick = async (e) => {
    ...
    localStorage.setItem('RegManufactureNumber', ResdocumentNum);

    let typeValue;
    if (selectedOption === 'Individual') {
      typeValue = '1';
      localStorage.setItem('ManufacturecompanyType', selectedOption);
      ...
      typeValue = '3';
      localStorage.setItem('ManufacturecompanyType', selectedCompanyType);
    }

    localStorage.setItem('ManufactureRegistrationType', typeValue);
    ...
    uploadTask.on(
      ...
      () => {
        getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
          ...
          localStorage.setItem('RegManufactureImgUrl', downloadURL);
          Navigate('/kyc');
          setUploading(false);
        });
      }
